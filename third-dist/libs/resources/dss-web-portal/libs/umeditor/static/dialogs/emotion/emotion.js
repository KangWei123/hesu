(function() {
  ...
  UM.registerWidget('emotion', {
    ...
    initContent: function(_editor, $widget) {
      ...
      emotion.SmileyPath =
        _editor.options.emotionLocalization === true ? emotionUrl + 'images/' : 'http://img.baidu.com/hi/';
    ...
    initImgName: function() {
      let emotion = this.sourceData.emotion;
