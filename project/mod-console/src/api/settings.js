...
export default {
   ...
   * @param params
   */
  updateTTPaySetting(params) {
    return services.post(WpSchema + '/setting/pay/update_bytedance_trade', params, {
      action: '更新字节支付设置',
    });
  },
   ...
   */
  getTTPaySetting() {
    return services.get(WpSchema + '/setting/pay/query_bytedance_trade', {
      action: '获取字节支付设置',
    });
  },
  ...
  getBusinessPayInfo(params) {
    return services.json('/mall/b/sellerAppMch/selectByStoreId', params, {
      action: '获取商圈支付设置信息',
    });
  },

  createBusinessPayInfo(params) {
    return services.json('/mall/b/sellerAppMch/create', params, {
      action: '创建商圈支付设置信息',
    });
  },

  updateBusinessPayInfo(params) {
    return services.json('/mall/b/sellerAppMch/update', params, {
      action: '更新商圈支付设置信息',
    });
  },
  ...
  getWxPayTransfersSetting() {
    return services.get(WpSchema + '/setting/pay/queryPayTransfersConfig', {
      action: '获取付款到零钱配置',
    });
  },
   ...
   * @param params
   */
  updatePayTransfersSetting(params) {
    return services.post(WpSchema + '/setting/pay/savePayTransfersConfig', params, {
      action: '保存付款到零钱配置',
    });
  },
};
