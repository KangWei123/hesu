<template>
  <div class="wx-pc" v-loading="loading" element-loading-spinner="el-icon-loading">
    ...
    <div class="success" v-if="step == 'success'">
      ...
      <!-- 二维码 -->
      <H5QrCode v-if="showQrcodeUrl"></H5QrCode>
    </div>
  </div>
</template>
...
<script>
  ...
  import H5QrCode from '@/mod-console/src/components/h5-QrCode';
    ...
    computed: {
      ...
      allowOperate() {
        const editButton = scopeMenuEnum.getMenuScopeByIdentifier(
          ...
          scopeMenuEnum.dictionary.companyChildMenu.wkbWxSettingMenu.settingButton.mp_setting_edit
        );
        ...
        settingsApi
          ...
          .then(res => {
            ...
            this.values.qrcodeUrlIconStyle =
              ...
              this.showQrcodeUrl = true; // 显示二维码链接
            }
          })
          .always(() => {
            this.loading = false;
