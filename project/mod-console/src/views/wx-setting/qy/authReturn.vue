<template>
  <div class="auth-return-container" v-loading="loading">
    <div class="step">
      <div class="content">
    ...
    <ul class="itemOne">
      <li class="listOne">
        ...
        <el-button class="copy-btn" type="primary" ref="copyOne" data-clipboard-target="#foo1" @click="copyOne"
          >复制URL</el-button
        >
      </li>
      <li class="listOne">
        ...
        <el-input
          ...
          :placeholder="eventNotifyToken"
          :value="eventNotifyToken"
          id="foo2"
        />
        <el-button class="copy-btn" type="primary" ref="copyTwo" data-clipboard-target="#foo2" @click="copyTwo"
          >复制Token</el-button
        >
      </li>
      <li class="listOne">
        ...
        <el-button class="copy-btn" type="primary" ref="copyThr" data-clipboard-target="#foo3" @click="copyThr"
          >复制EncodingAESKey</el-button
        >
      </li>
    </ul>
    <div class="btn">
      <el-button type="primary" @click="completeReturn">完成返回</el-button>
      <br />
