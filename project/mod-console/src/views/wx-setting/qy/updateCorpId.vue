  ...
  <div class="wrap">
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        <el-button type="primary" @click="confirm" style="border-radius: 15px; background-color: #3879fb" v-if="!corpId"
          >确 定</el-button
        >
        <el-button type="primary" @click="save" style="border-radius: 15px; background-color: #3879fb" v-if="corpId"
          >保 存</el-button
        >
