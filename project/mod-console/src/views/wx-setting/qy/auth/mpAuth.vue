  ...
  <div class="wrap" v-loading="loading">
    ...
    <div class="confirmBtn">
      <el-button
        ...
        >取消</el-button
      >
      <el-button type="primary" @click="confirmCommit" v-if="flag" style="margin-left: 17px; background-color: #3879fb"
        >确认提交</el-button
      >
      <el-button type="primary" @click="confirmAmend" v-if="!flag" style="margin-left: 17px; background-color: #3879fb"
        >确认修改</el-button
      >
    </div>
    <p class="help">
      <span style="color: #3879fb; margin-left: 20px" @click="help" class="hint"
        >怎样查看小程序应用Secret及AgentId?</span
      >
