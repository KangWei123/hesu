  ...
  <div>
    <div class="user-appointment-deal" v-loading="loading">
      <div style="margin-bottom: 20px">
        <el-select v-model="agreementType" @change="handleChangeDeal" placeholder="请选择">
          <el-option v-for="item in agreementTypeOptions" :key="item.value" :label="item.label" :value="item.value">
          </el-option>
        </el-select>
...
<script>
  ...
  import { WEditor, PayProtocol } from '@/register/wechat3rd';
