  ...
  <div>
    ...
    >
      ...
      <el-form-item :label="formLabel + 'AppSecret'" prop="subWxAppSecret">
        <el-input type="input" v-model="proxyForm.subWxAppSecret" placeholder="请输入AppSecret"></el-input>
      </el-form-item>

      <el-form-item label="支付子商户号" prop="subMchId">
        <el-input type="input" v-model="proxyForm.subMchId" placeholder="请输入支付子商户号"></el-input>
      </el-form-item>

      <el-form-item label="支付Api密钥" prop="subCertPassword">
        <el-input type="input" v-model="proxyForm.subCertPassword" placeholder="请输入支付Api密钥"></el-input>
      </el-form-item>
