<template>
  <div class="invoice-edit">
    ...
    <div>
      <div v-for="(item, index) in list" :key="index" class="form-container">
        <company-form
          :company-data="item"
          :count="index"
          :len="list.length"
    ...
    <el-button type="primary" icon="el-icon-plus" class="add-btn" @click="handleAdd">新增企业信息</el-button>
  </div>
</template>
