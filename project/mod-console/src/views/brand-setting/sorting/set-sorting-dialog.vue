<template>
  ...
  >
    ...
    <el-form ref="form" :model="form" :rules="rules" label-width="140px">
      ...
      <el-form-item label="品牌分账比例：" prop="commissionPercent">
        <el-input
          class="setting-input"
          style="width: 200px"
          v-model="form.commissionPercent"
          placeholder="请输入品牌分账比例"
        ></el-input>
        <span>%</span>
    ...
    <store-select-dialog inner-dialog :selected-stores="form.suitStores" enable-multiple v-model="showStoreDialog">
    </store-select-dialog>
  </el-dialog>
</template>
