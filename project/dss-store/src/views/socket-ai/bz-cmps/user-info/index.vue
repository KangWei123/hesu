<template>
  <div class="user-info">
    ...
    <span class="suspected"
          v-if="data.faceTag===2">!</span>

    <div class="base">
      <div class="base-name">{{hideName}} <span v-show="data.employeeName">导购：{{data.employeeName || '--'}}</span></div>
      <div class="base-attr">
    ...
    <div class="arrive-record"
      ...
      <div class="record-list">
        <div class="record-item"
             v-for="(item, index) in arriveRecordList"
             :key="index">
          <div>{{item.time}}</div>
          <div>{{item.name}}</div>
        </div>
        <span class="no-data"
              v-show="!arriveRecordList.length">暂无数据</span>
      </div>
    </div>

    <!-- 商家标签 -->
    <div class="merchant-impression"
         :class="showVersions">
      <label-box :isVip='!!data.memberId'
                 :labelList="ImpressionList"
                 title="商家标签" />
    </div>
    <!-- 画像标签 -->
    ...
    <div class="accounts"
      ...
      <div class="accounts-list">
        ...
        <span class="no-data"
              v-show="!orderList.length">暂无数据</span>
      </div>
    </div>
    <!-- 智能推荐 -->
    <div class="recommend"
      ...
      <div class="recommend-list">
        ...
        <span class="no-data"
              v-show="!recommendList.length">暂无数据</span>
      </div>
    </div>
    <!-- 优惠券 -->
    <div class="coupon"
      ...
      <div class="coupon-list">
        ...
        <span class="no-data"
              v-show="!couponList.length">暂无数据</span>
      </div>
    </div>
  </div>
</template>
