    ...
    <!-- <el-tabs v-model="activeName"
      ...
      <el-tab-pane label="人脸客流量"
        ...
        <el-popover placement="bottom"
                    ...
                    v-if="!CAMERA"
                    content='需安装摄像头设备'>
          <span slot="reference">人脸客流量</span>
        </el-popover>
        <camera-flow v-if="activeName === 'face-passflow'"></camera-flow>
      </el-tab-pane>

      <el-tab-pane label="人脸客户量"
                   name="face-customer"
                   :disabled='!CAMERA'>
        ...
        <el-popover placement="bottom"
                    ...
                    trigger="hover"
                    content='需安装摄像头设备'>
          <span slot="reference">人脸客户量</span>
        </el-popover>
        <camera-flow type="客户"
                     v-if="activeName === 'face-customer'"></camera-flow>
      </el-tab-pane>
    </el-tabs> -->

    <camera-flow type="客流"></camera-flow>
  </div>
</template>

<script>
import CameraFlow from './camera-flow.vue';
