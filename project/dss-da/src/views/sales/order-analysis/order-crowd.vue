  ...
  methods: {
    setCharts() {
      this.charts = [
        {
          title: '性别',
          url: orderApi.URL_ORDER_CUSTOMER_GENDER_D,
          params: {
          ...
          customOption: {
            keys: ['orderTime', 'orderCnt', 'gender'],
            sortedLegend: [{ label: '男', value: 'M' }, { label: '女', value: 'F' }, { label: '未知', value: '未知' }]
          }
        },
        {
          title: '年龄',
          url: orderApi.URL_ORDER_CUSTOMER_AGE_D,
          params: {
            storeId: this.selectedStore.id,
            pageSize: 100,
            pageNo: 1,
        ...
        {
          title: '顾客忠诚度',
          url: orderApi.URL_ORDER_CUSTOMER_LOYALTY_D,
          params: {
            storeId: this.selectedStore.id,
            pageSize: 100,
            pageNo: 1,
          ...
          customOption: {
            keys: ['orderTime', 'orderCnt', 'loyalty'],
            sortedLegend: [{ label: '高', value: 'H' }, { label: '中', value: 'M' }, { label: '低', value: 'L' }]
          }
        },
        {
          title: '顾客购买力',
          url: orderApi.URL_ORDER_CUSTOMER_BUYPOWER_D,
          params: {
            storeId: this.selectedStore.id,
            pageSize: 100,
            pageNo: 1,
          ...
          customOption: {
            keys: ['orderTime', 'orderCnt', 'buyPower'],
            sortedLegend: [{ label: '高', value: 'H' }, { label: '中', value: 'M' }, { label: '低', value: 'L' }]
          }
        }
      ];
