<template>
  <div class="formtable">
    <div class="card-title">
      ...
      <span class="export-btn" v-if="this.tableData && this.tableData.length"
...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      //   column.bounceRate = column.bounceRate * 100 + '%';
      // });
      // console.log(this.tableData.scenceValue);
      this.tableData = this.parenformtable;
      this.eltable = this.status.eltable;
      this.select = this.status.select;
      this.getappkey();
      ...
      downloadExcel() {
        ...
        if (this.dateRange) {
          ...
          let url =
            ...
            '//' +
            location.host +
            '/athena/reportforms/downloadobtainanalysisdate?appKey=' +
            this.appKey +
            '&' +
            'beginDate=' +
            beginDate +
