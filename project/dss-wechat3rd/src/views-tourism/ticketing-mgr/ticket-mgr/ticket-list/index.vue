<template>
  <mgr-list-table
    ref="list"
    :mgrType="ticketType"
    mgrShelfPageUrl="/ticketing-mgr/ticket/operation-shelves"
    mgrDetailPageUrl="/ticketing-mgr/ticket/detail"
    mgrCreatePageUrl="/ticketing-mgr/ticket/create"
  ></mgr-list-table>
</template>
