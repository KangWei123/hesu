    ...
    <el-form :model="commentForm"
      ...
      <el-form-item label="评论图片"
        ...
        <image-selector style="margin-top: 10px;margin-right:10px;"
                        ...
                        :disable='index<5'
                        :key="index" />
        <div style="color: #858c99; font-size: 12px; font-weight: 400; line-height: 15px">建议尺寸1:1，最多5张图片</div>
      </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      loading: false,
      rules: {
        itemNo: [{ required: true, message: `请选择${this.itemType.label}`, trigger: 'blur' }],
        userName: [
      ...
      productType: this.itemType.label,
      productLabel: ''
    };
  },
  computed: {
  ...
  mounted() {
    this.productLabel = '选择' + this.productType + '：';
  }
};
</script>
