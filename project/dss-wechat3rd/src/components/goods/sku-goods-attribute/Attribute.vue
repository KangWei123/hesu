<template>
  <div class="goods-attribute-new">
    <div class="attr-select-container">
      <span class="attribute-name">规格名称：</span>
      ...
      <span class="add-attr-btn"
         v-if="!attrChildSelectorVisible && !isDisabledEdit"
    ...
    <div class="attr-item-container"
      ...
      <div class="custom-select-box" v-if="attrChildSelectorVisible">
        <el-select v-model="computeCurrentChildItem"
                  filterable
                  allow-create
                  default-first-option
                  popper-class="custom-select"
        ...
        <i class="del-btn" @click="onHideAttrChildSelector"></i>
      </div>
