...
(function() {
  ...
  window.UMEDITOR_CONFIG = {
    ...
    whiteList: {
      ...
      tspan: ['class', 'data-brushtype', 'style'],
      ...
      tt: ['style', 'class', 'id'],
      u: [],
      animate: ['from', 'to', 'begin', 'dur', 'attributeName', 'repeatCount'],
      // mpvoice: ['frameborder', 'class', 'data-title', 'src', 'isaac2', 'low_size', 'source_size', 'high_size', 'name', 'voice_encode_fileid'],
      ul: ['style', 'class', 'id'],
      svg: [
        'style',
        'class',
