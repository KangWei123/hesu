<template>
  <div v-loading="loading" class="user-flow">
    <div class="btn-box">
        ...
        <div>
          <div class="btn-box-item">
            <el-form-item label="用户搜索:">
              ...
              >
                <i
                  class="el-icon-picture-outline el-input__icon"
                  v-if="!ImgUrl"
                  slot="suffix"
                  @click="uploadImg"
                ...
                <div class="search-img" slot="suffix" v-if="ImgUrl">
                  <img :src="ImgUrl" />
                  <i class="el-icon-close search-icon" @click="deleteImg"></i>
                </div>
              </el-input>
            </el-form-item>
          </div>
          ...
          <el-button type="primary" style="background: #409eff; font-size: 12px; margin-left: 8px" @click="onQuery"
            >查看</el-button
          >
        </div>
      </el-form>
    ...
    <div class="compare-table tag-table">
      <template>
        <template v-if="customerTagData && customerTagData.length">
          <el-table :data="customerTagData" stripe style="width: 100%">
            ...
            <el-table-column prop="enterCount" label="到店次数" min-width="80"></el-table-column>
            <el-table-column prop="memberType" label="用户类型" min-width="100">
              <template slot-scope="scope">
            ...
            <el-table-column prop="enterTime" :formatter="formateDateTime" label="进店时间(最近)"> </el-table-column>
            <el-table-column label="操作" min-width="100">
              <template slot-scope="scope">
                <popover :row="scope.row"></popover>
                <a href="javascript:void (0);" style="margin-left: 10px" @click="editTag(scope.row)">编辑</a>
              </template>
            </el-table-column>
          </el-table>
          <el-pagination
      ...
      <editor-dialog
        :show-member-editor="showMemberEditor"
        :user-data="userData"
      ...
      <image-dialog
        :show-editor="showImgDialog"
        v-if="showImgDialog"
        @choose="imageColse"
        :close-handler="imgColse"
      ></image-dialog>
  ...
  export default {
    ...
    methods: {
      ...
      apiNewTagData(autoRefresh) {
        ...
        const params = {
          enterTimeAnchor: enterTime || undefined,
          pageNo: 1,
