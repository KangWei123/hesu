  ...
  <div class="wkb-order-list">
    ...
    <div class="order-list-box">
      ...
      <order-list-table v-loading="loading"
                        ...
                        :order-type="orderTab.ORDER_TYPE.GIFT_CARD"
  ...
  methods: {
    queryUserPower() {
      if (this.wkbScopeMenu) {
        const giftCardOrderButton = scopeMenuEnum.dictionary.wkbChildMenu.wkbOrderMgrMenu.giftCardOrderButton;

        const scopeImportGiftCardOrder = scopeMenuEnum.getMenuScopeByIdentifier(
          this.wkbScopeMenu,
          giftCardOrderButton.import_gift_card_order
        );
        this.isPowerExport = !!scopeImportGiftCardOrder && !!scopeImportGiftCardOrder.status;
      }
    },
    // 查询订单列表
    listOrders() {
      ...
      params['itemTypeList[0]'] = orderStatusEnum.ORDER_TYPE.GIFT_CARD.value;
