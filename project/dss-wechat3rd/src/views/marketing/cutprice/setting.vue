<template>
  <div v-loading="isLoading"
       class="cutprice-activity-setting wkb-market-setting">
    <div class="setting">
      <el-form label-width="100px"
        ...
        <el-form-item label="样式设置："
          ...
          <div class="img-notes">物美价廉的好货，赶紧来砍价吧！(最长15个字符)</div>
        </el-form-item>
