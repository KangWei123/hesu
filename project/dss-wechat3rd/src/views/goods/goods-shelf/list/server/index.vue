  ...
  methods: {
    queryUserPower() {
      if (this.wkbScopeMenu) {
        const serverButoon = scopeMenuEnum.dictionary.wkbChildMenu.wkbGoodsMgrMenu.storeShelfMenu.serverButoon;
        // 查看
        const scopeShowGoodsButton = scopeMenuEnum.getMenuScopeByIdentifier(
          this.wkbScopeMenu,
          serverButoon.server_goods_show
        );
        ...
        const scopeShelfGoodsButton = scopeMenuEnum.getMenuScopeByIdentifier(
          this.wkbScopeMenu,
          serverButoon.server_shelf_goods
        );
        ...
        const scopePriceGoodsButton = scopeMenuEnum.getMenuScopeByIdentifier(
          this.wkbScopeMenu,
          serverButoon.server_price_goods
        );
        ...
        const scopeEditGoodsButton = scopeMenuEnum.getMenuScopeByIdentifier(
          this.wkbScopeMenu,
          serverButoon.server_goods_edit
        );
