<template>
  <div class="mp-is-empty">
    ...
    <div class="op-block">
      ...
      <div class="desc">建议先完成<span :title="this.allowOperate ? '' : '暂无权限操作'"
              @click="toCertification">店铺认证</span>，请确保小程序认证主体和当前店铺主体一致。</div>
    ...
    <div class="op-block">
      ...
      <div class="desc">
        ...
        <span :title="this.allowOperate ? '' : '暂无权限操作'"
              @click="toViewJoinParticulars">注册事项</span>
      </div>
      <el-button type="primary"
                 class="btn btn2"
                 size="mini"
