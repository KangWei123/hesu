  ...
  <div class="wx-card"
    ...
    <div class="main">
      ...
      <div class="main-left">
        <div class="tips">
          <p class="fw"
             style="line-height: 1;">绑定公众号授权后，在惟客宝平台生成的优惠券、会员卡，可以同步发布至用户的微信卡包中。</p>
        ...
        <div class="state-content">
          <div class="tab">
            ...
            <span class="btn"
                  ...
                  @click="bindAuthorize('pc')">重新授权</span>
          </div>
          <div class="tab">
            <span>小程序授权状态：</span>
            ...
            <span class="btn"
                  ...
                  :title="this.allowOperate ? '' : '暂无权限操作'"
                  @click="bindAuthorize('mp')">重新授权</span>
          </div>
          <div class="tab">
            <span>卡券功能：</span>
            ...
            <span class="nots"
               v-if="this.info.cardAuthStatus === 2">*请至微信后台手动开通卡券功能，再重新授权</span>
            <span class="btn"
...
export default {
  ...
  computed: {
    ...
    allowOperate() {
      const editButton = scopeMenuEnum.getMenuScopeByIdentifier(
        this.wkbScopeMenu,
        scopeMenuEnum.dictionary.wkbChildMenu.wkbWxSettingMenu.wxCardButton.wx_card_edit
      );
  ...
  methods: {
    ...
    bindCourse() {
      if (this.allowOperate) {
        $router.push({ path: '/setting/wx/card/course' });
      }
    },
    //开通卡券功能
    bindOpen() {
