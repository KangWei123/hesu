<template>
  <div class="seckill-module-edit">
    <edit-header :data-source="dataSource" name="秒杀"></edit-header>
    ...
    <div class="com-body">
      ...
      <commonEdit
        ...
        :nav-page="linkedPages.page.SEC_KILL_PAGE"
  ...
  export default {
    ...
    methods: {
      onChooseGoods(choosedGoodsList) {
        // 删除不需要的字段
        this.dataSource.data = utils.saveAvailableFields(choosedGoodsList, fields.seckill);
      },
