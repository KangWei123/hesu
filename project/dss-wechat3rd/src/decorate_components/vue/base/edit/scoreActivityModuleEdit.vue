<template>
  <div class="article-module-edit">
    <edit-header :data-source="dataSource" name="积分活动"></edit-header>
    <div class="com-body">
      ...
      <commonEdit
        ...
        title="选择积分活动"
        tips-label="活动"
        :nav-page="linkedPages.page.SCOREACTIVITY"
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        linkedPages,
        type: goodsTypeEnum.scoreActivity,
      };
    },
    watch: {},
    ...
    methods: {
      onChooseGoods(choosedGoodsList) {
        // 删除不需要的字段
        this.dataSource.data = utils.saveAvailableFields(choosedGoodsList, fields.scoreActivity);
      },
