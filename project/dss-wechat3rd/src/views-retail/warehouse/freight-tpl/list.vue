<template>
  <div class="freight-tpl-list-container" v-loading="loading">
    <div class="new-tpl-box">
      <el-button size="mini" class="new-tpl-btn" @click="handleAddNewTpl" type="primary">
        新增模板
      </el-button>
    </div>
    ...
    <el-dialog class="delete_freight_tpl_dialog" :visible.sync="delTemplateDialogVisible" width="50%" center>
      ...
      <span slot="footer" class="dialog-footer">
        <el-button size="mini" @click="delTemplateDialogVisible = false">取 消</el-button>
        <el-button size="mini" type="primary" @click="handleConfirmDel">确 定</el-button>
      </span>
    </el-dialog>
  </div>
</template>
