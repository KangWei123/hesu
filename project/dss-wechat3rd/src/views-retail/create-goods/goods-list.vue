<template>
  <manage-goodsList-table
    ref="list"
    add-product-path="/retail/goods-mgr/product/list/add"
    manage-label-path="/retail/goods-mgr/product/list/label-manage"
      ...
      assembleOrderMgrMenu() {
        ...
        scopeMenu.childMenu &&
          scopeMenu.childMenu.forEach(item => {
            ...
            if (item.identifier == 'batch_del_goods' && item.isHasPermission == 1) {
              this.batchDel = true;
            }
          });
      },
