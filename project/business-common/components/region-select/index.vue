<template>
  <el-cascader :props="cascaderProps" v-bind="{ ...defaultProps, ...$props }" v-on="$listeners"></el-cascader>
</template>
  ...
  export default Vue.extend({
    ...
    methods: {
      ...
      async fetchList(level, node) {
        ...
        return list.map(i => ({ label: i.name, value: i.name, id: i.id, leaf: level === MAX_LEVEL }));
      },
