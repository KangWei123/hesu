<template>
  <el-dialog title="选择项目" :visible.sync="dialogVisible" width="800" :before-close="dialogBeforeClose">
    <list-page-layout>
      <template #filters>
        <div class="filter">
          <div class="app-box">
      ...
      <fat-table
        ...
        row-key="id"
      >
        <el-table-column prop="name" align="center" label="项目名称"> </el-table-column>
        <el-table-column prop="area" align="center" label="项目区域"> </el-table-column>
        <el-table-column align="center" label="所属应用">
          <span v-text="appObj.appName"></span>
        </el-table-column>
      </fat-table>
    </list-page-layout>
    <div slot="footer">
...
<script>
  import { sharedStoreApi } from '@/business-common/api';
  ...
  export default {
    ...
    methods: {
      ...
      async handleFetch(e) {
        ...
        const { data, totalCount } = await sharedStoreApi.stroeQuery(params);
