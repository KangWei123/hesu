          ...
          <ul>
            <li>
              <a class="assets-recharge-btn" href="javascript:;" style="cursor:auto;">
                <img src="../../images/assets/icon04.png" width="28" alt="微信支付" />
                微信支付
              </a>
            </li>
            <!-- <li class="active">
               <a class="assets-recharge-btn" href="javascript:;">
                <img src="../../images/assets/icon05.png" width="28" alt="支付宝支付">
                支付宝支付
              </a>
            </li> -->
          </ul>
...
export default {
  data() {
    ...
    return {
      ...
      rules: {
        otherMoney: [{ validator: validateMoney, trigger: 'blur' }, { pattern: money.reg, message: money.msg }]
      }
    };
  },
  mounted() {},
