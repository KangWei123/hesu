  ...
  <div class="edit-app">
    <el-form ref="form"
      ...
      <el-form-item label="客服电话"
        ...
        <el-input type="input"
                  placeholder="请输入客服电话"
                  v-model.trim="form.servicePhone"></el-input>
      </el-form-item>
      ...
      <el-form-item label="联系人姓名"
        ...
        <el-input type="input"
                  ...
                  v-model.trim="form.contactsName"></el-input>
      </el-form-item>
      ...
      <el-form-item label="联系人电话"
        ...
        <el-input type="input"
                  ...
                  v-model.trim="form.contactsPhone"></el-input>
      </el-form-item>
