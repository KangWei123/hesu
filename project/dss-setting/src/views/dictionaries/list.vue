<template>
  <div class="dictionaries-area-list"
       v-loading="isLoading"
       :element-loading-text="msg.update">


    <div class="dictionaries-filter">
    </div>
    ...
    <div class="dictionaries-list">
      ...
      <el-table :data="dictionariesData"
      ...
      <div class="dictionaries-detail">
        ...
        <div class="empty" v-if="!dictionaryId">
          <span>!</span>请点击字典查看详情
        </div>
        <el-table v-else
                  :data="tableData"
    ...
    <dictionaries-dialog :data="currentObj"
                         @done="getList(true)"
...
import dictionariesEnum from '@/dss-setting/src/constants/dictionariesEnum.js';
