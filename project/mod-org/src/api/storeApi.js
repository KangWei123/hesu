...
import { WpSchema, PlatformSchema, PortalSchema, OrgSchema } from '@/business-common/constants/apiEnum';
...
export function getStoreList(params) {
  return services.get(OrgSchema + '/store/queryList', {
    action: '查询门店',
    params,
  });
}
...
export function queryAppConfig(params) {
  return services.get(OrgSchema + '/store/queryappconfig', {
    params,
    action: '获取品牌物流方式',
  });
}
...
export function addStore(params) {
  return services.post(OrgSchema + '/store/add', params, {
    action: '添加门店',
  });
}
...
export function updateStore(params) {
  return services.post(OrgSchema + '/store/update', params, {
    action: '修改门店',
  });
}
...
export function viewStore(params) {
  return services.get(OrgSchema + '/store/detail', {
    action: '查询门店',
    params,
  });
}
...
export const exportStoreListNew = OrgSchema + '/store/info/export';
