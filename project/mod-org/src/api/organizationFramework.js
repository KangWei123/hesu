...
/**
 * 查询获取组织树信息列表
 * queryEmployee  是否查询直属员工数量
 * queryStore  是否显示组织下的门店
 * queryType 查询列表，1 根据角色查询，2 全量查询  惟客云默认为2
 * showDeptApp 是否显示组织下的应用。 惟客云默认为false
 */
...
export function addOrganization(params) {
  return services.json(OrgSchema + '/organization/add', params, { action: '添加组织树' });
}
...
export function delOrganization(params) {
  return services.post(OrgSchema + '/organization/delete', params, { action: '删除组织树', hidden: true });
}
...
export function updateOrganization(params) {
  return services.json(OrgSchema + '/organization/update', params, { action: '更新组织树' });
}
...
export function getStoreList(params) {
  return services.get(OrgSchema + '/store/queryList', { params, action: '查询门店' });
}
...
export function getAttrList(params) {
  return services.get(OrgSchema + '/attr/list', { params, action: '查询组织属性' });
}
...
export function addOrganizationAttr(params) {
  return services.json(OrgSchema + '/attr/add', params, { action: '增加组织属性' });
}
...
export function deleteOrganizationAttr(params) {
  return services.post(OrgSchema + '/attr/delete', params, { action: '删除组织属性' });
}
...
export function updateOrganizationAttr(params) {
  return services.json(OrgSchema + '/attr/update', params, { action: '修改组织属性' });
}
