  ...
  <div class="start-up-create">
    ...
    <div class="creating"
      ...
      <el-form ref="form"
        ...
        <el-form-item label="选择地图位置"
                      prop="longitude"
                      ref="mapFormItem">
          <div class="dss-map"
               id="id_for_map">地图初始化容器
          </div>
        </el-form-item>
        ...
        <el-form-item label="详细地址"
          ...
          <el-input type="input"
                    ...
                    placeholder="请填写详细地址，方便会员查找"></el-input>
        </el-form-item>
    ...
    <div class="created"
      ...
      <div class="_desc">如果您有微信公众号及小程序，马上把店铺与微信打通吧，<br/>
      ...
      <div class="_btns"
           v-loading="!storeChanged"
           element-loading-spinner="el-icon-loading">
        <el-button type="primary"
                   size="mini"
                   @click="toBind">去绑定公众号及小程序
        </el-button>
        <el-button size="mini"
                   @click="toConsole">稍后再说，进入店铺后台
        </el-button>
      </div>
