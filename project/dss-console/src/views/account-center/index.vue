<template>
  <module-entry :business-scope-menu="companyScopeMenu"
                page-name="账户中心"
                :module-menu-key="companyCenterKey">
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        companyCenterKey: scopeMenuEnum.dictionary.companyChildMenu.account_center
      };
    },
    computed: {
      ...mapState({
